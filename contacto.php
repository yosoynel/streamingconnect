<?php
// Este archivo solo muestra información de contacto, no productos.
?>
<!DOCTYPE html>
<html>
<head>
<title>Contacto - Streaming Connect</title>
...
.card{background:#f5f5f5;margin:15px;padding:20px;border-radius:10px;width:350px;box-shadow:0 2px 6px rgba(0,0,0,0.1);text-align:center;transition:0.2s;}
...
<p>WhatsApp: <a href="https://wa.me/573235830919">+57 323 5830919</a></p>
<p>Email: streamingconnect@gmail.com</p>
<p>Instagram: <a href="https://instagram.com/streamingconnect">@streamingconnect</a></p>
</div>
</div>
</body>
</html>