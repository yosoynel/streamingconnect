...
$result = $conn->query("SELECT * FROM productos WHERE categoria = 'combos'");
?>

<!DOCTYPE html>
<html>
<head>
<title>Combos - Streaming Connect</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<style>
/* ... Copia los estilos de index.php ... */
...
<div class="title">
<h1>Combos</h1>
<p>Ofertas especiales de Streaming Connect</p>
</div>
<div class="container">
